...
db_ids = ["6112806bc9147f673d28c6ec", "693c61cf97a010153dc4d4b2", "697a4077891fda1733d14a31", "62d1026687ec2c2f0faa4949"]
...
batch_to_insert = new_docs[:5]
with open('next_batch.json', 'w') as f:
    json.dump(batch_to_insert, f)

print(f"Prepared 5 docs. Total remaining: {len(new_docs)}")
